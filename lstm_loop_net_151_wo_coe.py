...
# noise_count = 5 # CANTIDAD DE PICOS MAXIMOS Y MINIMOS "RUIDOSOS" A QUITAR
# del_count = noise_count * 2 # CANTIDAD DE ELEMENTOS TOTALES A REMOVER
# a = demand_ds.copy()

# max_idxs = get_max_idxs(a , noise_count)
# for i in max_idxs:
#     print("Removiendo elemento %d" % i)
#     a = numpy.delete(a , i , axis=0)

# min_idxs = get_min_idxs(a , noise_count)
# for i in min_idxs:
#     print("Removiendo elemento %d" % i)
#     a = numpy.delete(a , i , axis=0)

# del_idxs = max_idxs + min_idxs

# for del_idx in del_idxs:
#     DIFF_DEMAND = numpy.delete(DIFF_DEMAND, del_idx, axis=0)
#     demand_ds = numpy.delete(demand_ds, del_idx, axis=0)
#     vars_ds = numpy.delete(vars_ds, del_idx, axis=0)
#     dates_ds = numpy.delete(dates_ds, del_idx, axis=0)
