...
def dates_match(data_entry, balance_entry):
    ...
    balance_date_wr = dp.parse_date_wformat(balance_date_str, BALANCE_DATE_FORMAT)
    print(balance_date_wr)
...
#   0       1
# fecha;saldo_cierre
balance_df = pandas.read_csv('saldo_cierre_100_pesos.csv', usecols=[0, 1], delimiter=";")
...
full_balance_df.to_csv('full_saldo_salida_pesos_100.csv')
